...
% java -Xmx2500m -Xms2500m -XX:NewRatio=3 -jar MADAMIRA-release-20190603-2.1.jar -i samples/xml/SampleInputFile.xml  -o  SampleOutputFile.xml

Use the following command to process a raw file.

% java -Xmx2500m -Xms2500m -XX:NewRatio=3 -jar MADAMIRA-release-20190603-2.1.jar -rawinput samples/raw/SampleTextInput.txt -rawoutdir  . -rawconfig samples/sampleConfigFile.xml
...
% java -Xmx2500m -Xms2500m -XX:NewRatio=3 -jar MADAMIRA-release-20190603-2.1.jar -s

On a separate shell/command prompt, use the following command to run the client. 

% java -Xmx2500m -Xms2500m -XX:NewRatio=3 -jar MADAMIRA-release-20190603-2.1.jar -c -i samples/xml/SampleInputFile.xml  -o  SampleOutputFile.xml
